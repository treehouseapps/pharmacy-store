...
<body>
    ...
    <center>
        <h1 class="reg">REGISTER Admin</h1>
        <div class="form-box">
            <form class="form" action="admin_store.php" method="POST" enctype="multipart/form-data"> <span class="title">ADD Admin</span>
                <span class="subtitle">Create admin accounts</span>
